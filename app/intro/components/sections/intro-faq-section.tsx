...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "별도 요금제 신청 없이 서비스를 이용할 수 있어요. 채용에 필요한 크레딧은 미리 충전해서 사용해요.",
  },
  {
    question: "언제 결제하나요?",
    answer:
  ...
  {
    question: "크레딧은 얼마부터 충전할 수 있나요?",
    answer:
      "크레딧은 자유롭게 충전할 수 있어요. 600 크레딧 이상 충전 시 계좌이체는 15%, 카드 결제는 11% 할인이 적용돼요.",
  },
  {
    question: "수수료는 어떻게 책정되나요?",
    answer:
      "연봉과 무관하게 채용 1명당 300 크레딧(정찰제)이 차감돼요. 포지션 연봉이 높아져도 차감량은 동일해요.",
  },
  {
