    ...
    >
      <div className="flex items-start justify-between gap-3">
        <p
          className={cn(
            ...
            isCredit ? "text-[#0b3d8f]" : "text-[#0b0f1c]",
          )}
        >
          채용 성공 수수료
        </p>
      ...
      <div className="mt-4 flex flex-wrap items-baseline gap-x-2">
        <p
          className={cn(
            ...
            isCredit ? "text-[#1A7CFF]" : "text-[#0b0f1c]",
          )}
        >
          {amount}
        </p>
        {amountLabel ? (
          <span
            className={cn(
              ...
              isCredit ? "text-[#5b8fd9]" : "text-[#9aa5b8]",
            )}
          >
            ({amountLabel})
          </span>
      ...
      <p
        className={cn(
          ...
          isCredit ? "text-[#3f4a60]" : "text-[#5d6a82]",
        )}
      >
        {description}
      </p>
