...
export function JdListFooter({ className }: JdListFooterProps) {
  return (
    ...
    >
      ...
      <div className="mt-4 space-y-1 text-xs leading-relaxed text-neutral-500">
        <p>고객센터 : 1688-7360 | support@starting.kr</p>
        <p>
          스타팅파트너스(주) | 대표이사 : 김홍찬 | 본사 : 서울특별시 광진구 능동로 81, 3층 | 지사/연구소 : 서울특별시 중구
          퇴계로 15, 5층
        </p>
        <p>
          사업자등록번호 : 313-88-02068 | 통신판매번호 : 2025-서울광진-0701 | 직업정보제공번호 : 서울동부 제 2026-6 호 |
          유료직업소개번호 : 제 2025-3040234-14-5-00005 호
        </p>
      </div>
    </footer>
  )
